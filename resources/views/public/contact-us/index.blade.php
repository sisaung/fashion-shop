...
@section('content')
    <div class="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 md:py-7">
        ...
        <div class="max-w-2xl mx-auto px-4 py-12">
            <!-- Heading -->
            <h2 class="text-3xl font-semibold font-heading mb-4">Contact Us</h2>

            <!-- Intro -->
            <p class="mb-6 text-gray-600">Keep in touch with our shop.</p>
            ...
            <form class="space-y-4">
                <div>
                    ...
                    <input type="text" id="name" name="name"
                        class="
                        w-full bg-white rounded border border-gray-300 focus:border-pearl-bush-400 focus:ring-2
                        focus:ring-pearl-bush-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors
                ...
                <div>
                    ...
                    <input type="email" id="email" name="email"
                        class=" w-full bg-white rounded border border-gray-300 focus:border-pearl-bush-400 focus:ring-2
                        focus:ring-pearl-bush-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors
                        duration-200 ease-in-out"
                        required>
                </div>
                ...
                <button type="submit"
                    class="text-white bg-pearl-bush-400 border-0 py-2 px-8 focus:outline-none hover:bg-pearl-bush-600 rounded text-sm  cursor-pointer  duration-300">Send
                    Message</button>
            </form>
