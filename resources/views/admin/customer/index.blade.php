                ...
                <div class="w-full overflow-x-auto rounded-lg border border-gray-200 ">
                    <table class="w-full divide-y divide-gray-200">
                        ...
                        <tbody class="divide-y divide-gray-200 bg-white">
                            ...
                            @foreach ($customers as $customer)
                                <tr>
                                    ...
                                    <td class="whitespace-nowrap px-4 py-4 text-sm text-gray-900 text-end">
                                        <div class="">
                                            <p> {{ date('j M Y', strtotime($customer->created_at)) }} </p>
                                            <p> {{ date('g:i A', strtotime($customer->created_at)) }} </p>
                                        </div>
                                    </td>
                                    <td class="whitespace-nowrap px-4 py-4 text-sm text-gray-900 text-end">
                                        <div class="">
                            ...
                            @empty($customers)
                                <tr>
                                    <td colspan="5" class="text-center text-gray-700"> There are no customers.
