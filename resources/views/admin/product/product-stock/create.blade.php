            ...
            <div class="flex gap-x-3 justify-center items-center">
                ...
                <div>
                    <a href="{{ route('manage-image.edit', ['id' => $product->id]) }}"
                        class="cursor-pointer size-12 inline-flex justify-center items-center bg-pearl-bush-500 border-2 border-dashed border-pearl-bush-300  rounded-full">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="size-5 text-white">
                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div>
                    <p
                        class="size-12 inline-flex justify-center items-center border-2 border-dashed border-pearl-bush-300 bg-pearl-bush-500 rounded-full">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="size-5 text-white">
                            <path stroke-linecap="round" stroke-linejoin="round"
