...
@section('content')
    <div class="flex justify-between items-center">
        <div>
            @include('components.admin.breadcrumb', [
                ...
                'links' => [['name' => 'Manage Product', 'path' => 'product.index','product' => '']],
                'pathKey' => ''
            ])
        </div>
        ...
        <div class="flex gap-x-3 justify-center items-center">
            ...
            <div>
                <p
                    class="size-12 inline-flex justify-center items-center border border-dashed border-pearl-bush-600 rounded-full">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 stroke-pearl-bush-400">
    ...
    <h1 class="mt-10 text-xl px-5"> Edit Product </h1>
    <div>
